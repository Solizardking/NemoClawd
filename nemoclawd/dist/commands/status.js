...
function isInsideSandbox() {
    return (0, node_fs_1.existsSync)("/sandbox/.openclaw") || (0, node_fs_1.existsSync)("/sandbox/.nemoclawd");
}
async function cliStatus(opts) {
    ...
    if (state.migrationSnapshot) {
        ...
        logger.info("  Run 'openclaw nemoclawd eject' to restore host installation.");
    }
}
