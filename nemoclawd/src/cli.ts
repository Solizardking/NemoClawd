...
/**
 * CLI registrar for `openclaw nemoclawd <subcommand>`.
 *
...
export function registerCliCommands(ctx: PluginCliContext, api: OpenClawPluginApi): void {
  ...
  const nemoclawd = program.command("nemoclawd").description("NemoClawd sandbox management");
