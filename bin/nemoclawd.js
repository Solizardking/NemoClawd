...
async function deploy(instanceName) {
  ...
  console.log("");
  console.log(`  Deploying NemoClawd to Brev instance: ${name}`);
  console.log("");
  ...
  console.log("  Syncing NemoClawd to VM...");
...
async function launch(actionArgs = []) {
  ...
  console.log("");
  console.log(`  Launching NemoClawd → ${sandboxName}`);
  if (!hasTelegramToken) {
...
async function quickStartSolana(actionArgs = []) {
  ...
  console.log("");
  console.log("  ⚡ NemoClawd Solana Quick Start");
  console.log("  ═══════════════════════════════");
  console.log("");
